    ...
    <html lang="fr" className={`${geistSans.variable} antialiased`}>
      <body className="flex min-h-svh items-center justify-center bg-background p-4 text-foreground">
        <div className="w-full max-w-sm text-center">
          <p className="text-5xl font-extrabold tracking-tight text-destructive sm:text-6xl">Erreur 500</p>
          <h1 className="mt-3 text-xl font-semibold tracking-tight">Une erreur inattendue est survenue</h1>
