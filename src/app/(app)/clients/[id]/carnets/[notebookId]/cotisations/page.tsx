...
import type { ApiEnvelope, Collection, Notebook } from "@/lib/types";
...
export default async function CollectionsPage(
  ...
  const { data: collections } = await apiFetch<ApiEnvelope<Collection[]>>(`/collections/notebook/${notebookId}`);
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="mb-3 text-lg font-medium tracking-tight">Historique ({collections.length})</h2>
